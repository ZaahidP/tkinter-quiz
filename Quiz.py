...
from quiz_widgets import QuizLabels, Option_Button, QuestionButtons, VerticalFrame
...
#Frame for top
    ...
    def create_frames(self):
        ...
        self.bottom_frame = VerticalFrame(self,"grey")
    ...
    def create_widgets(self):
        ...
        self.answer.grid(column=2, row=1, sticky="nsew")
