...
def question_1(question, btn1, btn2, btn3, btn4):
        question.configure(text="Question 1")
        btn1.configure(text="q1")
        btn2.configure(text="q1")
    ...
    def question_2(question, btn1, btn2, btn3, btn4):
        ...
        btn1.configure(text="q2")
        btn2.configure(text="q2")
    ...
    def question_3(question, btn1, btn2, btn3, btn4):
        ...
        btn1.configure(text="q3")
        btn2.configure(text="q3")
    ...
    def question_4(question, btn1, btn2, btn3, btn4):
        question.configure(text="Question 4")
        btn1.configure(text="q4")
        btn2.configure(text="q4")
